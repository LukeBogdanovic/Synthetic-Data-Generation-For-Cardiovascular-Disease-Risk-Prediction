 ...
 */
__declspec(dllexport) double dtw_distance(double *seq1, double *seq2, int len1, int len2, int dim)
{
 ...
 * @return MMD score
 */
__declspec(dllexport) double compute_mmd(double *X, double *Y, int rows_X, int rows_Y, int cols, double sigma)
{
