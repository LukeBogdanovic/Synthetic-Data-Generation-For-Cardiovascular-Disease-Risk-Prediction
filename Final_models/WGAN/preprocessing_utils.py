...
def plot_generated_sample(generated_signal, lead_mins, lead_maxs, amount_signal: int = 320):
    '''
    ...
    generated_sample = bandpass_filter(generated_sample, b, a)
    # Subplot the leads
    fig, axs = plt.subplots(3, 1, figsize=(10, 8))
    lead_labels = ['Lead III', 'Lead V3', 'Lead V5']
    for i, ax in enumerate(axs):
        ax.plot(generated_sample[:amount_signal, i])  # Take half of the signal
