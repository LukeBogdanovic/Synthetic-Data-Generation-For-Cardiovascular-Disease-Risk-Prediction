...
dataset    = TensorDataset(ecg_tensor, nsr_labels)
...
print(f"\nAccuracy on PTB-XL NSR samples (ECG-only): {correct}/{n_loaded} ({correct/n_loaded*100:.1f}%)")
print("\nPrediction breakdown:")
print(results['predicted_label'].value_counts().to_string())

results.to_csv("ptbxl_nsr_ecg_only_results.csv", index=False)
print("\nSaved: ptbxl_nsr_ecg_only_results.csv")