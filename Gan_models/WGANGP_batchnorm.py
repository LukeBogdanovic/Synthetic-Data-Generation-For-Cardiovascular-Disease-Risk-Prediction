...
def train(generator, critic, dataloader, num_epochs, latent_dim, n_critic, lambda_gp, g_optimizer, c_optimizer, device, image_path, model_path, lead_mins, lead_maxs):
    generator.train()
    critic.train()
    metrics_history = {
        'epoch': [],
...
def main():
    ...
    train(generator, critic, dataloader, num_epochs, LATENT_DIM, n_critic, lambda_gp,
